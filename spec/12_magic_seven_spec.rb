...
describe MagicSeven do
  ...
  describe '#subtract_four' do
    context 'when the number to subtract is 6' do
      it 'returns 2' do
        number_to_subtract = 6
        result = game.subtract_four(number_to_subtract)
  ...
  describe '#divide_by_two' do
    context 'when the number to divide is 6' do
      it 'returns 3' do
        number_to_divide = 6
        result = game.divide_by_two(number_to_divide)
  ...
  describe '#subtract_random_number' do
    ...
    context 'when class initializes with 2' do
      context 'when the number to subtract is 6' do
        it 'returns 4' do
          number_to_subtract = 6
          result = game.subtract_random_number(number_to_subtract)
